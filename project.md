...
```json
{
  "_id": {"$oid": "..."},              // Unique transaction ID
  "vendorId": "...",                    // Vendor identifier
  "itemName": "...",                    // Expense item name
  "itemDescription": "...",             // Expense description
  "accountId": "...",                   // Account ID (alternative target)
  "accountName": "...",                 // Account name (PRIMARY TARGET)
  "itemTotalAmount": 0.00               // Transaction amount in SGD
}
```
